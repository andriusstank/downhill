...
Except that `bvarGrad` is not the value of the gradient, it's an
...
There's a difference between linear and bilinear (or multilinear) functions.
...
Linearity is a much stronger restriction than multilinearity.
